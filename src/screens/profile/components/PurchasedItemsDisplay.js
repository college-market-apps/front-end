...
function PurchasedProductsItem({item, index, onPressItem, currentUserId}){
            ...
            <View style={styles.shoppingItems}>
                ...
                <View style={[isEven? {marginLeft: 10} : {marginRight: 10}]}>
                    <View style={styles.itemStatus}>
                        <Image source={{uri: profileUri}} style={styles.profileImageProduct}/>
...
export default function PurchasedItemsDisplay({ purchasedProducts, currentUserId, onPressItem }){
    ...
    return (
        <View style={styles.sellectedScreen}>
            <FlatList
                data={purchasedProducts} // screens
